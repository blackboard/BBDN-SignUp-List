...
Whether you download or deploy to run the demo you will need to visit developer.blackboard.com and create a developer account and application. You will use the key and secret provide on the heroku deploy page or to update the local configuration file if running locally. 